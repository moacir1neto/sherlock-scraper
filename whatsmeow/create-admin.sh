...
# Script para criar super admin usando o código Go do projeto
...
read -p "Nome [Admin]: " NOME
NOME=${NOME:-Admin}

read -p "Email [admin@admin.com]: " EMAIL
EMAIL=${EMAIL:-admin@admin.com}

read -sp "Senha [admin123]: " SENHA
SENHA=${SENHA:-admin123}
echo ""

echo -e "${YELLOW}💾 Criando usuário usando código Go do projeto...${NC}"
...
docker run --rm \
    ...
    temp-builder go run scripts/create-super-admin.go "$NOME" "$EMAIL" "$SENHA"
