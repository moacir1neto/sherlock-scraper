...
func (s *RedisInstance) Update(ctx context.Context, id string, toUpdate *models.Instance) (*models.Instance, error) {
	...
	// DisplayName: sempre atualiza (permite definir ou limpar nome amigável)
	oldInstance.DisplayName = toUpdate.DisplayName
	...
	if toUpdate.Webhook.SecretUpdate != nil {
		oldInstance.Webhook.Secret = *toUpdate.Webhook.SecretUpdate
	}
